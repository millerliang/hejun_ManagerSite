...
// Head meta, css Links
head_items = '<meta name="description" content="" />';
head_items += '<meta name="viewport" content="width=device-width, initial-scale=1.0" />';
head_items += '<!-- basic styles -->';
//head_items += '<link href="assets/css/bootstrap.min.css" rel="stylesheet" />';
head_items += '<link href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">';
head_items += '<link rel="stylesheet" href="assets/css/font-awesome.min.css" />';
...
head_items += '<!--[if IE 7]>';
head_items += '<link rel="stylesheet" href="assets/css/font-awesome-ie7.min.css" />';
head_items += '<![endif]-->';
head_items += '<!-- ace styles -->';
head_items += '<link rel="stylesheet" href="assets/css/ace.min.css" />';
head_items += '<link rel="stylesheet" href="assets/css/ace-rtl.min.css" />';
head_items += '<link rel="stylesheet" href="assets/css/ace-skins.min.css" />';
head_items += '<link rel="stylesheet" href="assets/css/pushy-buttons.min.css" />';
head_items += '<!--[if lte IE 8]>';
head_items += '<link rel="stylesheet" href="assets/css/ace-ie.min.css" />';
head_items += '<![endif]-->';
head_items += '<!-- ace settings handler -->';
head_items += '<script src="assets/js/ace-extra.min.js"></script>';
head_items += '<!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->';
head_items += '<!--[if lt IE 9]>';
head_items += '<script src="assets/js/html5shiv.js"></script>';
head_items += '<script src="assets/js/respond.min.js"></script>';
head_items += '<![endif]-->';
$('head').append(head_items);

// Top Comany Logo
$('.navbar-brand').append("<small>後台管理系統</small>");

// Aside Nav bar
aside_items = "<li>";
aside_items += "<a href='#0'><i class='fa fa-tv'></i> <span class='menu-text'>節目管理</span></a>";
aside_items += "</li>";

aside_items += "<li>";
aside_items += "<a href='index.html'><i class='fa fa-angle-right'></i> <span class='menu-text'>1.課程管理</span></a>";
aside_items += "</li>";

aside_items += "<li>";
aside_items += "<a href='2.html'><i class='fa fa-angle-right'></i> <span class='menu-text'>2.套餐管理</span></a>";
aside_items += "</li>";

aside_items += "<li>";
aside_items += "<a href='3.html'><i class='fa fa-angle-right'></i> <span class='menu-text'>3.團購管理</span></a>";
aside_items += "</li>";

aside_items += "<li>";
aside_items += "<a href='4.html'><i class='fa fa-angle-right'></i> <span class='menu-text'>4.作業批改</span></a>";
aside_items += "</li>";

aside_items += "<li>";
aside_items += "<a href='5.html'><i class='fa fa-angle-right'></i> <span class='menu-text'>5.講員管理</span></a>";
aside_items += "</li>";

aside_items += "<li>";
aside_items += "<a href='6.html'><i class='fa fa-angle-right'></i> <span class='menu-text'>6.會員管理</span></a>";
aside_items += "</li>";

aside_items += "<li>";
aside_items += "<a href='7.html'><i class='fa fa-angle-right'></i> <span class='menu-text'>7.廠商管理</span></a>";
aside_items += "</li>";

aside_items += "<li>";
aside_items += "<a href='8.html'><i class='fa fa-angle-right'></i> <span class='menu-text'>8.訂單管理</span></a>";
aside_items += "</li>";

aside_items += "<li>";
aside_items += "<a href='9.html'><i class='fa fa-angle-right'></i> <span class='menu-text'>9.促銷管理</span></a>";
aside_items += "</li>";

aside_items += "<li>";
aside_items += "<a href='10.html'><i class='fa fa-angle-right'></i> <span class='menu-text'>10.通路管理</span></a>";
aside_items += "</li>";

aside_items += "<li>";
aside_items += "<a href='11.html'><i class='fa fa-angle-right'></i> <span class='menu-text'>11.積分管理</span></a>";
aside_items += "</li>";

aside_items += "<li>";
aside_items += "<a href='12.html'><i class='fa fa-angle-right'></i> <span class='menu-text'>12.代幣管理</span></a>";
aside_items += "</li>";

aside_items += "<li>";
aside_items += "<a href='13.html'><i class='fa fa-angle-right'></i> <span class='menu-text'>13.課程卡管理</span></a>";
aside_items += "</li>";

aside_items += "<li>";
aside_items += "<a href='14.html'><i class='fa fa-angle-right'></i> <span class='menu-text'>14.廣告設定</span></a>";
aside_items += "</li>";

aside_items += "<li>";
aside_items += "<a href='15.html'><i class='fa fa-angle-right'></i> <span class='menu-text'>15.營運報表</span></a>";
aside_items += "</li>";

aside_items += "<li>";
aside_items += "<a href='basic_seting.html'><i class='fa fa-cog'></i> <span class='menu-text'>基礎設定</span></a>";
aside_items += "</li>";

$('.nav-list').append(aside_items);

// User menuBar
//ace_items = "<li class='color'>";
//ace_items += "<a data-toggle='dropdown' class='dropdown-toggle' href='#'>";
//ace_items += "<i class='icon-envelope icon-animated-vertical'></i>";
//ace_items += "<span class='badge badge-important'>12</span></a>";
//ace_items += "<ul class='pull-right dropdown-navbar navbar-pink dropdown-menu dropdown-caret dropdown-times'>";
//ace_items += "<li><a href='user_feedback.html'><div class='clearfix'><span class='pull-left'>";
//ace_items += "<i class='btn btn-xs no-hover btn-primary icon-info'></i>訊息通知</span>";
//ace_items += "<span class='pull-right badge badge-success'>+8</span>";
//ace_items += "</div></a></li>";
//ace_items += "<li><a href='user_feedback.html'>查看所有通知<i class='icon-arrow-right'></i>";
//ace_items += "</a></li></ul></li>";
ace_items = "<li class='light-blue'><a data-toggle='dropdown' href='#' class='dropdown-toggle'>";
ace_items += "<img class='nav-user-photo' src='assets/avatars/user.gif' alt='Jason's Photo' />";
ace_items += "<span class='user-info'>";
ace_items += "<small>您好, 歡迎</small>Admin</span>";
ace_items += "<i class='icon-caret-down'></i></a>";
ace_items += "<ul class='user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-times'>";
ace_items += "<li><a href='admin_profile.html'>";
ace_items += "<i class='fa fa-user-o'></i> 個人資料</a>";
ace_items += "</li><li class='divider'></li>";
ace_items += "<li><a href='login.html'>";
ace_items += "<i class='fa fa-sign-out'></i> 登 出</a>";
ace_items += "</li></ul></li>";
$('.ace-nav').append(ace_items);
